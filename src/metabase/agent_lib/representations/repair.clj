...
;;; instance's start-of-week setting - i.e. it *is* the `:instance` semantics the model is reaching
;;; for. So we drop any unsupported mode, leaving the supported default. `:iso` and the bare
;;; (no-mode) forms are left untouched.
;;;
